...
def get_sclaed_values(input_data):
    data = get_clean_data()
...
def add_predictions(input_data):
    ...
    st.write('The Cell Cluster according to the model is:')
...
def main():
    ...
    with st.container():
        ...
        st.write("This program is a simple AI tool designed to help doctors predict whether a tumor is benign (harmless) or malignant (cancerous) based on cell measurements from a cytology lab.")
